// src/components/weekly/content/EnhancedActivities.tsx
// Enhanced activities component with bulk input capability
...
const EnhancedActivities = (props: ActivitiesProps) => {
  const {
    weeklyActivities,
    setWeeklyActivities,
    nextWeekPlan,
  ...
  const handleBulkImport = (importedWeekly: ActivityRow[], importedNext: ActivityRow[]) => {
    // Combine with existing activities or replace them
