            ...
            {imagePreviewSrc(group.images?.[0]) ? (
              <div className="relative w-full h-full">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 p-2 bg-red-500 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 hover:bg-red-600 shadow-lg"
                >
                  <X className="w-4 h-4" />
                </button>
