  ...
  return (
    <div className="space-y-6 mb-8">
      {sections.length > 0 ? (
        ...
        <div className="text-center py-12 bg-background rounded-lg border-2 border-dashed border-muted">
          <Folder className="w-12 h-12 text-muted-foreground mb-4 mx-auto" aria-hidden="true" />
